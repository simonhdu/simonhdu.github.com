...
if (! function(a, b) {
  ...
  }(), window.pageConfig = window.pageConfig || {}, "undefined" == typeof pageConfig.autoConfig && (pageConfig.autoConfig = !0), "undefined" == typeof pageConfig.preload && (pageConfig.preload = !0), pageConfig.jdfVersion || (pageConfig.jdfVersion = "1.0.0"), pageConfig.jdfBaseUri || (pageConfig.jdfBaseUri = "http://misc.360buyimg.com/"), pageConfig.autoConfig) {
  var preloadArray = pageConfig.preload ? ["http://misc.360buyimg.com/jdf/" + pageConfig.jdfVersion + "/ui/ui/" + pageConfig.jdfVersion + "/ui.js"] : [];
  var seajsConfig = {
  ...
  ("localhost" == location.hostname || /isdebug=(-\d)*-1/.test(location.search)) && (seajsConfig.comboExcludes = /.*/), seajs.config(seajsConfig)
}
